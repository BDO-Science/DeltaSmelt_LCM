...
CalSim <- read.csv(file.path("Salinity_Zooplankton_analysis","FlowZoopData_2022ROC_EffectsAnalysis_CohortYear_2024-09-05.csv"),header=T)
...
write.csv(all.lamAB,file=file.path("DeltaSmeltLCME_output","lamAB.ROC_2024-09-10.csv"))
write.csv(all.lam.mn,file=file.path("DeltaSmeltLCME_output","lam.mn.ROC_2024-09-10.csv"))
