...
data_model <-read_xlsx("BoR Reinitiation LCME results_11-06-2023.xlsx", skip = 1, sheet="CalSim flow actions") %>% select(c(1:12)) %>%
  rename(Year = names(.)[1],Empirical=base) %>% filter(Year %in% c(1995:2015)) %>%
  rename(Alt1 = Alt1...3,
         Alt2v1wTUCP = Alt2v1wTUCP...4,
         Alt2v1woTUCP =Alt2v1woTUCP...5,
         Alt2v2noTUCP =Alt2v2noTUCP...6,
         Alt2v3noTUCP = Alt2v3noTUCP...7,
         Alt3=Alt3...8,
         Alt4=Alt4...9,
         EXP1=EXP1...10,
         EXP3=EXP3...11)
...
```{r plot 4,echo=FALSE, messages=FALSE, dpi=300, fig.width=8, fig.height=11}
...
#Create figure
plot_bar_param_wet <- ggplot2::ggplot(data=data_input_barplot_wet, ggplot2::aes(x=scenario, y=Value, fill=scenario))+ facet_wrap(~ Parameter, ncol=2, scales="free")+
  ggplot2::theme_bw()+
  geom_col() +
  ggplot2::theme(plot.title=element_text(size=9), 
                 axis.text.x=element_text(size=9, color="black",angle=45,hjust=1), 
...
#Create figure
plot_bar_param_dry <- ggplot2::ggplot(data=data_input_barplot_dry, ggplot2::aes(x=scenario, y=Value, fill=scenario))+ facet_wrap(~ Parameter, ncol=2, scales="free")+
  ggplot2::theme_bw()+
  geom_col() +
  ggplot2::theme(plot.title=element_text(size=9), 
                 axis.text.x=element_text(size=9, color="black",angle=45,hjust=1), 
