...
original_scenario_file<-read.csv("CSAMP_DS_SDM_salinity_scenarios.csv")

#Join the two datasets
scenario_file <- original_scenario_file %>% select(c(1:6)) %>% left_join(salinity_data) %>% 
  rename(sal_NAA=NAA,sal_D1641=D1641)
